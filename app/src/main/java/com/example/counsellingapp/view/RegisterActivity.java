 ...
 *   <li>Route to the student dashboard via {@link LandingActivity#routeByRole(String, Context, Runnable)} on success.
 * </ul>
 *
...
public class RegisterActivity extends AppCompatActivity {
     ...
     * {@link LandingActivity#routeByRole(String, Context, Runnable)} — the same path taken after login.
     */
