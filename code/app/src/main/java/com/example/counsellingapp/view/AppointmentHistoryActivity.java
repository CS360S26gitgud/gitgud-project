        ...
        appointmentController.getStudentAppointmentHistory(studentId, new AppointmentController.AppointmentListCallback() {
            ...
            public void onSuccess(List<Appointment> appointments) {
                ...
                for (Appointment appt : appointments) {
                    String counselorName = (appt.getCounselor() != null) ? appt.getCounselor().getName() : "N/A";
                    String dateStr = (appt.getTimeSlot() != null)
                            ? appt.getTimeSlot().getDate() + " " + appt.getTimeSlot().getStartTime()
                            : "N/A";
                    appointmentDisplayList.add("With: " + counselorName + "\nDate: " + dateStr + "\nStatus: " + appt.getStatus());
                }
