...
|----|------------|----------|--------|
|01|As a student, I want to register for an account using my university credentials...|High|Done|
|02|As a student, I want to log in securely so that my personal information...|High|Done|
|10|As a student, I want to be able to search/filter through the available list of counselors...|Medium|Done|
|11|As a student, I want to view my appointment history so that I can keep track of past sessions|Low|Done|
